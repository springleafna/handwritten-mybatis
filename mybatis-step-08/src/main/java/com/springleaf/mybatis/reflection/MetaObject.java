...
import com.springleaf.mybatis.reflection.wrapper.*;
...
/**
 * 元对象，用于操作对象的属性
 * 这是整个反射体系的核心入口类。它封装了一个对象的所有读写操作。
 * MetaObject 是 MyBatis 提供的统一属性访问入口，它封装了目标对象（可以是 POJO、Map、Collection 等），
 * 并提供一致的 API 来读写属性，无论底层是哪种数据结构。
 */
